...
const nextConfig = {
  ...
  // كاش webpack على القرص يتجاوز 1.5 جيجابايت في هذا المشروع، وهو سبب
  // فشل البناء بـ ENOSPC على أجهزة ضيقة المساحة. تعطيله يبطئ عمليات
  // إعادة البناء المحلية قليلاً ولا يؤثر على ناتج البناء إطلاقاً.
  // فيرسل تبني في بيئة نظيفة، فلا أثر للإعداد هناك.
  webpack: (config) => {
