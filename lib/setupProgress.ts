...
export async function getSetupProgress(workspaceId: string, userId: string): Promise<SetupProgress> {
  ...
  const steps: SetupStep[] = [
    ...
    },
    {
      ...
      descAr: "نتابع الحملات التي تختارها فقط.",
      descEn: "We track only the campaigns you pick.",
    ...
    },
    {
      ...
      descAr: "راجع القرارات المقترحة ونفّذ أحدها.",
      descEn: "Review suggested decisions and apply one.",
