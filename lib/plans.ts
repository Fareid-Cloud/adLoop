...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    // 🔴 **٣٬٣٤٩ لا ٣٬٢٩٩ - والنسبةُ هي السبب.** الخصمُ يُحسب من الرقمين
    // (`offerDiscountPct`) ولا يُكتب بيد، و٣٬٢٩٩ كانت تعطي ٢٤٪ بينما
    // الريال والدولار يعطيان ٢٥٪ - فالصفحةُ الواحدة تعرض نسبتين لنفس
    // الباقة حسب عملةِ القارئ.
    // والتصحيحُ في السعر الأساسيّ لا في النصّ عمداً: كتابةُ «٢٥٪» فوق
    // رقمين يعطيان ٢٤٫٢٥٪ سعرٌ مرجعيٌّ كاذب، وهو ما يحظره قانونُ حماية
    // المستهلك صراحةً - ومَن يطرح الرقمين يكتشفه في ثانية.
    listPrice: { EGP: 3_349, SAR: 749, USD: 199 },
    limits: {
