...
// سياسة كلمة المرور: ثمانية أحرف على الأقلّ، بخليط من حروف كبيرة وصغيرة
// وأرقام ورموز. كلّ شرط يُفحص وحده برسالة صريحة، ليعرف المستخدم ما الناقص
// بالضبط بدل رفض عامّ مربك.
const passwordSchema = z
  .string()
  .min(8, "كلمة المرور ثمانية أحرف على الأقلّ")
  .max(200)
  .regex(/[a-z]/, "يجب أن تحتوي على حرف صغير (a-z) واحد على الأقلّ")
  .regex(/[A-Z]/, "يجب أن تحتوي على حرف كبير (A-Z) واحد على الأقلّ")
...
export const signupSchema = z.object({
  ...
  // الموافقة جزء من المخطَّط لا فحصاً لاحقاً: هكذا تُرفض قبل أيّ معالجة،
  // ولا يمكن أن يمرّ تسجيل بلا موافقة عبر مسار جديد يُضاف مستقبلاً.
  acceptedTerms: z.literal(true, {
    message: "يلزم الاطّلاع على شروط الاستخدام وسياسة الخصوصية والموافقة عليهما.",
  }),
});
