...
>
> وما يبقى **ليس حاجزاً ولا عيباً**: ثغرتان متوسّطتان متعدّيتان تحت عميل جوجل
> (`gaxios`, `uuid`) لا فكاك منهما ضمن النطاق، والسحبُ التلقائيّ من البطاقة -
> **قرارُ عملٍ ينتظر تأكيد Paymob**، ونصُّ الشروط اليوم يصف الواقع بصدق فلا
> يستعجله شيء. والتأكيداتُ الخارجية موثَّقةٌ في `activation-checklist.md`.
