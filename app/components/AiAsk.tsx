...
//
// **٣) شفّاف وهو يطفو، معتم وهو راسٍ.** الشفافية ليست زينة: المربّع يمرّ
// فوق أرقام تُقرأ، فإعتامه الكامل أثناء التمرير يحجب ما جاء المستخدم
    ...
    <>
      <div
        className={`sticky bottom-5 z-30 mt-6 transition-opacity duration-300 ${
          solid ? "opacity-100" : "opacity-[0.62] hover:opacity-90"
        }`}
      >
        <div
