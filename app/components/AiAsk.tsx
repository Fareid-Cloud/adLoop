  ...
  return (
    <>
      ...
      <div
        ...
        // الجانبيّ يدوياً وتتبّع حالة طيّه. **وهذا السبب لا وجود له على
        // الهاتف** - الشريط هناك درجٌ لا عمودٌ في المجرى. فالثابت للهاتف
        // وحده، واللاصق يبقى كما هو من `sm` فأعلى بلا حرفٍ يتغيّر.
