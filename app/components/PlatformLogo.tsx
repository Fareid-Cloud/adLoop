...
export function PlatformLogo({ platform, size = 18 }: { platform: string; size?: number }) {
  ...
  switch (platform) {
    case "GOOGLE_ADS":
      ...
      return (
        <svg viewBox="0 0 192 192" style={s} aria-label="Google Ads" shapeRendering="geometricPrecision">
          <rect
            x="52.4" y="12" width="44" height="150" rx="22"
            fill="#FBBC04" transform="rotate(30 74.4 87)"
          />
          <rect
            x="95.6" y="12" width="44" height="150" rx="22"
            fill="#4285F4" transform="rotate(-30 117.6 87)"
          />
          <circle cx="52" cy="150" r="26" fill="#34A853" />
        </svg>
      );
    case "GOOGLE":
