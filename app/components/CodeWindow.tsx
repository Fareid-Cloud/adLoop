...
export function CodeWindow({
  ...
  return (
    <div className="code-window">
      ...
      {/* 🔴 **وسمُ التتبّع وحده نحو خمسين سطراً**، فكتلةٌ بلا سقفٍ تدفع
          كلَّ ما بعدها خارج الشاشة - وما بعدها هو جدولُ الصفحات وبقيّةُ
          البنود. السقفُ يجعل الطويلَ يُمرَّر في مكانه، والقصيرَ يبقى
          بطوله الطبيعيّ لأنّه لا يبلغه أصلاً.
          والشريطُ هنا هو شريطُ القائمة الجانبية نفسه: رفيعٌ بلون الهوية،
          يظهر عند الاقتراب - لا شريطُ النظام الرماديّ العريض. */}
      <pre
        dir="ltr"
        className="hover-scrollbar scrollbar-zone code-block max-h-[22rem] overflow-auto p-3 text-[12px] leading-[1.7]"
      >
        <code>
          {lines.map((line, i) => (
