...
export const viewport: Viewport = {
  ...
  initialScale: 1,
  viewportFit: "cover",
  // 🔴 لوحة المفاتيح على أندرويد تُصغّر **نافذة العرض المرئية** افتراضياً
  // ولا تمسّ نافذة التخطيط، فيبقى كلّ عنصرٍ مثبَّت بأسفل الشاشة **تحتها
  // مختفياً** - ومربّع السؤال حقلُ إدخال، أي أنّه يختفي في اللحظة التي
  // يُستعمل فيها بالضبط. وبهذه القيمة تُصغَّر نافذة التخطيط نفسها، فيرتفع
  // المثبَّت فوق لوحة المفاتيح من تلقائه.
